...
#%%
   ...
   # Access Stokes V at slit 0, map 0 via difference method
    ...
    data_plot = np.array([I[:,100:-100,100:-100],Q[:,100:-100,100:-100], U[:,100:-100,100:-100], V[:,100:-100,100:-100]])
...
#%% 
    Q = result.difference.Q.mean(axis=1)
    U = result.difference.U.mean(axis=1)    
    data_plot = np.array([I[0,100:-100,100:-100],Q[0,100:-100,100:-100], U[0,100:-100,100:-100]])
